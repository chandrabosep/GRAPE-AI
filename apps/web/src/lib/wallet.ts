 ...
 * Wallet sign-in.
 *
 * Deliberately built on EIP-1193 directly rather than a wallet-kit, so injected
 * wallets work with no project id, no cloud account and no configuration at all.
 * WalletConnect layers on top of this for mobile and remote wallets when a
