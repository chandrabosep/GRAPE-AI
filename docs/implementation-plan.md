# GRAPE AI — Implementation Plan (ETHOnline 2026)
...
- `pnpm i`; `pnpm db:migrate`; `pnpm dev` (turbo: web+api on :3001, x402-api :4402, extension esbuild watch). Press F5 in `apps/vscode-extension` for the Extension Development Host; `API_URL=http://localhost:3001`.
